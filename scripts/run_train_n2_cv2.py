"""c_v=2.0 ablation of the N=2 vector-maxⁿ run. Tests whether the value head is
gradient-starved at the default 1:1 loss weighting. Everything identical to
run_train_n2.py except value_loss_weight=2.0 and a separate run directory."""
