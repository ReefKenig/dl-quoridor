...
env = QuoridorEnvMP(board_size=9, num_players=N, max_turns=300,
                    max_walls_per_player=10)


def make_model():
    return QuoridorModelMP(board_size=9, action_space_size=140,
                           in_channels=3 * N + 3,   # = 9 at N=2
                           num_channels=128, num_res_blocks=10,
