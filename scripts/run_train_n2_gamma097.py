"""γ=0.97 ablation of the N=2 vector-maxⁿ run. Tests whether discount factor
drives value-loss drift. Everything identical to run_train_n2.py except
discount=0.97 and a separate checkpoint directory."""
